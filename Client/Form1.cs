...
namespace Client
{
    public partial class Form1 : Form
    {
        ...
        {
            Player = new Players();//створення екземпляру гравця
            Enemy = new Players();// створення екземпляру ворога
        }
        ...
        private async void Mstrip_connectItem_Click(object sender, EventArgs e)
        {
            ...
            if (obj.ID == 1 || obj.ID == 2)
            {
                ...
                // виставляемо координати на полі
                Player.StartPosition(Panel_gameField);
                // додаемо гравця на полі
            ...
            if (Player.ID == 1)
            {
                ...
                {
                    // додаемо противника на ігрове поле
